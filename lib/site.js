...
export const testimonials = [
  {
    text: "Showed up on time, communicated clearly, and left the place spotless.",
    location: "Huntington, NY",
  },
  {
    text: "The quote process was simple and the crew handled a tough cleanout with care.",
    location: "Babylon, NY",
  },
  {
    text: "Exactly the kind of local service that makes a stressful day easier.",
